...
S106_CAN_1 = Bool('S106_CAN_1')
S106_UAZ_1 = Bool('S106_UAZ_1')
S106_CALL_1 = Bool('S106_CALL_1')
S106_RU_0 = Bool('S106_RU_0')

s = Solver()
s.add(And(Not(S106_CAN_1), Or(And(S106_UAZ_1, S106_CALL_1), S106_RU_0)))
print(s.check())
print(s.model())
